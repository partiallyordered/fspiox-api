...
/// struct for typed errors of method `quotes`
...
/// struct for typed errors of method `quotes_by_id`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum QuotesByIdError {
    Status400(crate::models::ErrorInformationResponse),
    Status401(crate::models::ErrorInformationResponse),
    Status403(crate::models::ErrorInformationResponse),
    Status404(crate::models::ErrorInformationResponse),
...
/// struct for typed errors of method `quotes_by_id1`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum QuotesById1Error {
    Status400(crate::models::ErrorInformationResponse),
    Status401(crate::models::ErrorInformationResponse),
    Status403(crate::models::ErrorInformationResponse),
    Status404(crate::models::ErrorInformationResponse),
...
/// struct for typed errors of method `quotes_by_id_and_error`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum QuotesByIdAndErrorError {
    Status400(crate::models::ErrorInformationResponse),
    Status401(crate::models::ErrorInformationResponse),
    Status403(crate::models::ErrorInformationResponse),
    Status404(crate::models::ErrorInformationResponse),
...
pub async fn quotes(configuration: &configuration::Configuration, accept: &str, content_type: &str, date: &str, fspiop_source: &str, body: crate::models::QuotesPostRequest, content_length: Option<i32>, x_forwarded_for: Option<&str>, fspiop_destination: Option<&str>, fspiop_encryption: Option<&str>, fspiop_signature: Option<&str>, FSPIOP_URI: Option<&str>, fspiop_http_method: Option<&str>) -> Result<(), Error<QuotesError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/quotes", configuration.base_path);
    ...
    if local_var_status.is_success() {
        ...
        let local_var_entity: Option<QuotesError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn quotes_by_id(configuration: &configuration::Configuration, ID: &str, content_type: &str, date: &str, fspiop_source: &str, accept: &str, x_forwarded_for: Option<&str>, fspiop_destination: Option<&str>, fspiop_encryption: Option<&str>, fspiop_signature: Option<&str>, FSPIOP_URI: Option<&str>, fspiop_http_method: Option<&str>) -> Result<(), Error<QuotesByIdError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/quotes/{ID}", configuration.base_path, ID=crate::apis::urlencode(ID));
    ...
    if local_var_status.is_success() {
        ...
        let local_var_entity: Option<QuotesByIdError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn quotes_by_id1(configuration: &configuration::Configuration, ID: &str, content_type: &str, date: &str, fspiop_source: &str, body: crate::models::QuotesIdPutResponse, x_forwarded_for: Option<&str>, fspiop_destination: Option<&str>, fspiop_encryption: Option<&str>, fspiop_signature: Option<&str>, FSPIOP_URI: Option<&str>, fspiop_http_method: Option<&str>, content_length: Option<i32>) -> Result<(), Error<QuotesById1Error>> {
    ...
    if local_var_status.is_success() {
        ...
        let local_var_entity: Option<QuotesById1Error> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn quotes_by_id_and_error(configuration: &configuration::Configuration, ID: &str, content_type: &str, date: &str, fspiop_source: &str, body: crate::models::ErrorInformationObject, content_length: Option<i32>, x_forwarded_for: Option<&str>, fspiop_destination: Option<&str>, fspiop_encryption: Option<&str>, fspiop_signature: Option<&str>, FSPIOP_URI: Option<&str>, fspiop_http_method: Option<&str>) -> Result<(), Error<QuotesByIdAndErrorError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/quotes/{ID}/error", configuration.base_path, ID=crate::apis::urlencode(ID));
    let mut local_var_req_builder = local_var_client.put(local_var_uri_str.as_str());
    ...
    if local_var_status.is_success() {
        ...
        let local_var_entity: Option<QuotesByIdAndErrorError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
